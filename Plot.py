...
files = ['/gpfsnyu/home/bx2038/Covariate-shift-CRT/Results/Power_eff_est_n1000_0.1_L3.txt', '/gpfsnyu/home/bx2038/Covariate-shift-CRT/Results/Power_eff_true_n1000_0.1_L3.txt']
...
plt.xlabel('Effect size', fontsize=14)  # X-axis label with fontsize
plt.ylabel('Power', fontsize=14)  # Y-axis label with fontsize
plt.ylim(0, 1)  # Set y-axis limits to 0 and 1
plt.title('Power vs Effect', fontsize=16)  # Title with fontsize
plt.legend(fontsize=12)  # Legend with fontsize
plt.grid(True, linestyle='--', alpha=0.6)  # Add grid lines
plt.savefig('/gpfsnyu/home/bx2038/Covariate-shift-CRT/Plot/True_vs_estimate_eff_power.png', dpi=300, bbox_inches='tight')  # Save as a high-resolution image
